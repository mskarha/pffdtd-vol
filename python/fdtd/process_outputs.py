...
def main():
    ...
    parser.add_argument('--resample_Fs', type=float,help='output Fs for processed outputs (optional, only needed for WAV files)')
    ...
    parser.set_defaults(resample_Fs=None)
